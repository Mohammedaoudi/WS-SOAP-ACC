package ma.ensa.tpksoap2.service;
...
import ma.ensa.tpksoap2.utils.Constants;
public class CompteService {
    public List<Compte> getComptes() throws Exception {
        // Création de la requête SOAP
        SoapObject request = new SoapObject("http://ws.tp_comptes.example.com/", "getComptes");
    ...
    public Compte createCompte(String type, double solde) throws Exception {
        ...
        SoapObject request = new SoapObject("http://ws.tp_comptes.example.com/", Constants.METHOD_CREATE_COMPTE);
    ...
    public boolean deleteCompte(Long id) throws Exception {
        ...
        SoapObject request = new SoapObject("http://ws.tp_comptes.example.com/", Constants.METHOD_DELETE_COMPTE);
        request.addProperty("id", id);
